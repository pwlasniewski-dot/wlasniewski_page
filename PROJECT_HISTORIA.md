...
- Trzy addytywne migracje zastosowano na produkcyjnym `main`; historia Prisma ma 21/21 zakończonych migracji i zero wpisów wycofanych.
- Kontrola przed i po wdrożeniu potwierdziła zachowanie 8 zapytań, 7 rezerwacji i 2 kodów promocyjnych. Grafik zawiera 35 reguł dla pięciu usług, komplet siedmiu dni oraz dziewięć reguł kończących się po północy.
- PR #50 scalono do `main` jako `fa5c0f9869e419f8232e897988264429ffa54202`, a Netlify opublikował nową wersję na `wlasniewski.pl`.
- Produkcyjny smoke test potwierdził sesję 2 h w dni robocze wyłącznie w przedziałach 18:00–20:00, 19:00–21:00 i 20:00–22:00 oraz sobotnie przyjęcie 3 h do 02:00 następnego dnia.
- Kalendarz blokuje zbyt bliskie terminy 29–30 sierpnia zgodnie z minimalnym wyprzedzeniem. Nie utworzono testowej rezerwacji ani płatności.
...
- ✅ `bcrypt` - Password hashing for client aut…6949 tokens truncated… to strictly block creation of new pages if the slug already exists (returns 400 Bad Request), preventing accidental overwrites.
