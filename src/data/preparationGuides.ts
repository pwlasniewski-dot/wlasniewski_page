import type { PoseGuideCard } from '@/types/preparation-guide';
...
export const WARDROBE_FALLBACK_TIPS = [
    { id: 'comfort', title: 'Zacznij od komfortu', content: 'Wybierz rzeczy, które dobrze leżą także w siadzie, ruchu i przy podnoszeniu rąk. Własny styl jest ważniejszy niż sztywna reguła.' },
    { id: 'palette', title: 'Koordynuj, nie kopiuj', content: 'Dla pary lub rodziny wybierz 2–4 współgrające kolory i podobny poziom formalności. Stroje nie muszą być identyczne.' },
    { id: 'patterns', title: 'Wzory z umiarem', content: 'Jeden wyrazisty wzór może być dobrym punktem wyjścia. Bardzo drobne, gęste desenie warto wcześniej sprawdzić na zdjęciu.' },
    { id: 'layers', title: 'Warstwy pomagają', content: 'Sweter, marynarka lub szal pozwalają dopasować strój do temperatury i szybko zmienić charakter zdjęcia.' },
    { id: 'women', title: 'Dla kobiet', content: 'Wybierz fason, w którym swobodnie stoisz, siedzisz i poruszasz rękami. Sukienka, garnitur, spodnie lub dzianina są równie dobre — ważne, żeby strój był Twój i nie wymagał ciągłego poprawiania.' },
    { id: 'men', title: 'Dla mężczyzn', content: 'Dobrze układająca się koszula, sweter, marynarka albo prosty T-shirt mogą wyglądać świetnie. Sprawdź długość rękawów i nogawek oraz to, czy kieszenie nie odkształcają ubrania.' },
    { id: 'children', title: 'Dziecko przede wszystkim wygodnie', content: 'Wybierz znane, miękkie ubranie, które nie ogranicza ruchu. Spakuj kompletny zestaw zapasowy.' },
    { id: 'home', title: 'Sesja domowa', content: 'Sprawdzą się miękkie warstwy, bose stopy lub czyste domowe obuwie i kolory współgrające z wnętrzem. Unikaj rzeczy, które szeleszczą albo wymagają ostrożnego siedzenia.' },
    { id: 'outdoor', title: 'Sesja plenerowa', content: 'Dopasuj ubranie do temperatury i podłoża. Zabierz wygodne buty na dojście, dodatkową warstwę oraz ochronę przed chłodem, słońcem lub wilgocią.' },
    { id: 'season', title: 'Pora roku', content: 'Wiosną i jesienią postaw na warstwy, latem na przewiewne materiały, a zimą na spójne okrycia wierzchnie. Komfort termiczny jest ważniejszy niż wybrana paleta.' },
    { id: 'avoid', title: 'Czego lepiej unikać', content: 'Duże logotypy, neonowe akcenty, bardzo drobne kontrastowe wzory i pełne kieszenie mogą odciągać uwagę. Jeśli są częścią Twojego stylu, nie są zakazane — pokaż zestaw wcześniej fotografowi.' },
    { id: 'black-white', title: 'Czerń, biel i mocne kolory', content: 'Możesz ich używać. Zamiast łączyć same skrajne kontrasty, dodaj kolor pośredni lub fakturę i sprawdź zestaw w świetle dziennym.' },
    { id: 'fitting', title: 'Przymierz cały zestaw', content: 'Załóż jednocześnie ubranie, buty i dodatki. Usiądź, przejdź kilka kroków i unieś ręce — szybko zauważysz elementy, które krępują ruch lub wymagają poprawiania.' },
    { id: 'packing', title: 'Spakuj pełne zestawy', content: 'Dodatki przypisz do konkretnych ubrań, buty zapakuj osobno, a delikatne elementy przewieź w pokrowcu.' },
];
