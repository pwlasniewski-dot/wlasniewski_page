...
const CATEGORY_PRESENTATION: Record<string, { title: string; label: string; description: string }> = {
    ...
    ewent: { title: 'Eventy i imprezy firmowe', label: 'Wydarzenia', description: 'Reportaż z wydarzenia, który pokazuje ludzi, energię i najważniejsze momenty.' },
    event: { title: 'Eventy i imprezy firmowe', label: 'Wydarzenia', description: 'Reportaż z wydarzenia, który pokazuje ludzi, energię i najważniejsze momenty.' },
    events: { title: 'Eventy i imprezy firmowe', label: 'Wydarzenia', description: 'Reportaż z wydarzenia, który pokazuje ludzi, energię i najważniejsze momenty.' },
    urodziny: { title: 'Urodziny i przyjęcia', label: 'Emocje', description: 'Urodziny, jubileusze i rodzinne uroczystości bez sztywnych póz.' },
    birthday: { title: 'Urodziny i przyjęcia', label: 'Emocje', description: 'Urodziny, jubileusze i rodzinne uroczystości bez sztywnych póz.' },
    przyjecie: { title: 'Urodziny i przyjęcia', label: 'Emocje', description: 'Urodziny, jubileusze i rodzinne uroczystości bez sztywnych póz.' },
