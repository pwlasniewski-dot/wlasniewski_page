...
/**
 * Prosty UI wyboru albumów-dodatków na stronie oferty klienta.
 * Bez galerii / wideo / wielkiego showcase — tylko lista z checkboxem.
 *
 * Logika cen:
 *  - `pages_count` w bazie = liczba STRON (np. 30 stron = 15 rozkładówek).
 *  - 1 rozkładówka = 2 strony.
 *  - Minimalna liczba rozkładówek: 10 (= 20 stron).
 *  - Cena za rozkładówkę: `price_per_spread` (domyślnie 40 PLN).
        ...
        <div className="px-4 sm:px-6 pb-6 border-t border-gold-500/20 pt-6">
            ...
            <p className="text-xs text-zinc-400 mb-4">
                {isLocked
                    ...
                    : 'Zaznacz album który chcesz dołączyć. Możesz zmienić liczbę rozkładówek — cena przeliczy się automatycznie.'}
            </p>
