...
export async function POST(
    ...
    try {
        ...
        const fileName = `offers/oferta_${offer.offerNumber || offerId}_custom_${randomUUID()}.pdf`;

        console.log(`[ADMIN_UPLOAD_PDF] Uploading custom PDF for offer ${offerId}, size: ${buffer.length}`);
        ...
        await recordAdminIncidentSafely({
            severity: 'P1', category: 'ADMIN_WRITE', reasonCode: 'ADMIN_OFFER_PDF_UPLOAD_FAILED',
            summary: 'Nie udało się zapisać PDF oferty', correlationId,
