            ...
            <div className="mx-auto max-w-4xl px-4 py-16 pt-32">
                ...
                <div className="prose prose-invert max-w-none">
                    <section className="mb-8">
                        ...
                        <p className="text-zinc-300 mb-4">
                            Kontakt: <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'pwlasniewski@gmail.com'}`} className="text-gold-400 hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'pwlasniewski@gmail.com'}</a>,
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-zinc-300 mb-4">
                            ...
                            Email: <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'pwlasniewski@gmail.com'}`} className="text-gold-400 hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'pwlasniewski@gmail.com'}</a>
                        </p>
                    </section>
                </div>
            </div>
