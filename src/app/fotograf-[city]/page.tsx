...
const CITIES: Record<string, CityInfo> = {
    ...
    grudziadz: {
        ...
        metaTitle: 'Fotograf Grudziądz – sesje rodzinne, ślubne i biznesowe',
        metaDescription: 'Fotograf w Grudziądzu. Sesje rodzinne, portretowe i biznesowe, reportaże ślubne oraz zdjęcia z drona. Sprawdź ofertę i wolne terminy.',
        ...
        lng: 18.7536,
        intro: [
            'Mam na imię Przemek. Fotografuję rodziny, pary, uroczystości i osoby, które potrzebują dobrego portretu do pracy lub własnej marki. Do Grudziądza dojeżdżam z Płużnicy, dlatego możemy umówić sesję zarówno w mieście, jak i w spokojniejszym plenerze w okolicy.',
            'Przed spotkaniem ustalamy, do czego mają służyć zdjęcia i jaki charakter najbardziej Ci odpowiada. Na tej podstawie wybieramy miejsce, porę dnia i zakres sesji. Dzięki temu w dniu zdjęć mamy konkretny plan, ale zostawiamy też miejsce na pomysły, które pojawią się już na miejscu.',
        ],
        sections: [
            {
                title: 'Gdzie możemy zrobić zdjęcia w Grudziądzu',
                icon: '📍',
                paragraphs: [
                    'Spichlerze i bulwar nad Wisłą dobrze sprawdzają się wtedy, gdy zależy nam na miejskim tle z charakterem. Możemy zacząć od kilku spokojnych portretów, a później przejść w stronę Góry Zamkowej lub ulic Starego Miasta. Taki spacer daje kilka różnych miejsc bez długich przejazdów.',
                    'Na sesję rodzinną chętnie wybieram Park Miejski albo tereny nad Wisłą, gdzie dzieci mają więcej swobody. Jeśli wolisz prostsze tło i mniej osób dookoła, poszukamy miejsca poza centrum — łąki, polne drogi i aleje drzew dobrze wyglądają szczególnie pod wieczór.',
                    'Nie trzymam się jednej listy lokalizacji. Miejsce dobieramy do rodzaju zdjęć, pogody oraz tego, gdzie po prostu będzie Ci wygodnie.',
                ],
            },
            {
                title: 'Jak wygląda spotkanie',
                icon: '📷',
                paragraphs: [
                    'Nie zakładam, że wiesz, jak stanąć przed aparatem. Na początku rozmawiamy i robimy kilka prostych ujęć, żeby spokojnie wejść w rytm sesji. Podpowiadam, gdzie spojrzeć, co zrobić z rękami albo w którą stronę się obrócić, ale nie ustawiam każdej pozycji co do centymetra.',
                    'Przy zdjęciach rodzinnych przeplatam portrety krótkim spacerem i zabawą z dziećmi. Podczas sesji biznesowej pracujemy bardziej precyzyjnie — pilnuję postawy, światła i detali, żeby fotografie pasowały do strony internetowej, profilu zawodowego lub materiałów firmy.',
                ],
            },
            {
                title: 'Zdjęcia po sesji',
                icon: '🖼️',
                paragraphs: [
                    'Po spotkaniu wybieram najlepsze ujęcia i każde z nich opracowuję. Gotowe fotografie przekazuję w prywatnej galerii internetowej, z której można wygodnie pobrać pliki na komputer i telefon.',
                    'W podstawowym pakiecie znajduje się minimum 20 zdjęć. Jeśli chcesz zamówić odbitki albo album, ustalimy format i sposób wykończenia. Standardowy termin oddania galerii wynosi do 10 dni roboczych.',
                ],
            },
        ],
        services: [
            { name: 'Sesja rodzinna w Grudziądzu', description: 'Zdjęcia rodziny w parku, nad Wisłą, na Starym Mieście albo w wybranym miejscu poza centrum.' },
            { name: 'Fotografia ślubna Grudziądz', description: 'Reportaż z wybranego zakresu dnia oraz sesja plenerowa ustalona osobno lub wykonana w dniu ślubu.' },
            { name: 'Sesja portretowa i biznesowa', description: 'Portrety na stronę internetową, LinkedIn, materiały firmowe lub po prostu dla siebie.' },
            { name: 'Fotografia komunijna Grudziądz', description: 'Zdjęcia podczas uroczystości oraz krótka sesja dziecka i rodziny po jej zakończeniu.' },
            { name: 'Zdjęcia z drona', description: 'Ujęcia miejsca, wydarzenia lub nieruchomości z powietrza, wykonywane po sprawdzeniu warunków lotu.' },
        ],
        faqs: [
            { question: 'Ile kosztuje sesja zdjęciowa w Grudziądzu?', answer: 'Sesja portretowa zaczyna się od 400 zł, a rodzinna od 500 zł. Cena zależy od liczby zdjęć i zakresu spotkania. Reportaż ślubny wyceniam po krótkiej rozmowie o planie dnia. Dojazd do Grudziądza jest wliczony w ustalony pakiet.' },
            { question: 'Gdzie możemy zrobić sesję w Grudziądzu?', answer: 'Najczęściej wybierane są spichlerze i bulwar nad Wisłą, Góra Zamkowa, Stare Miasto oraz Park Miejski. Możemy też spotkać się poza centrum. Miejsce dobieram do rodzaju sesji, pory dnia i pogody.' },
            { question: 'Czy trzeba umieć pozować?', answer: 'Nie. W trakcie sesji podpowiadam, jak się ustawić i co zrobić, żeby zdjęcie dobrze wyglądało. Zaczynamy spokojnie, a pierwsze minuty traktujemy jako czas na oswojenie się z aparatem.' },
            { question: 'Jak przygotować się do zdjęć?', answer: 'Po rezerwacji możemy omówić ubrania i miejsce. Najlepiej sprawdzają się rzeczy, w których dobrze się czujesz, dopasowane kolorystycznie do pozostałych osób. Warto zabrać wygodne buty, jeśli planujemy spacer po mieście.' },
            { question: 'Kiedy otrzymam gotowe fotografie?', answer: 'Standardowo wysyłam galerię do 10 dni roboczych od sesji. Przy reportażach i większych zamówieniach termin ustalam indywidualnie przed podpisaniem umowy.' },
        ],
        nearbyLinks: [
            { label: 'Fotograf Chełmno', href: '/fotograf-chelmno' },
