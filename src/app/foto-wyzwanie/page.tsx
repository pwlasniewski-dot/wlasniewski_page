...
import {
    ...
    Check, Shield, Award, Star, ChevronDown, Users, Mail, User as UserIcon, Phone
} from 'lucide-react';
        ...
        <div className="relative">
            ...
            >
                ...
                <label className="flex items-start gap-2 mb-5 cursor-pointer text-xs text-stone-600">
                    ...
                    <span>
                        Akceptuję{' '}
                        <Link href="/regulamin" target="_blank" className="text-amber-700 underline hover:text-amber-800">
                            regulamin
                        </Link>{' '}
                        i{' '}
                        <Link href="/polityka-prywatnosci" target="_blank" className="text-amber-700 underline hover:text-amber-800">
