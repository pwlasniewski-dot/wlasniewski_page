...
async function createPremiumB2BHomepage() {
  try {
    const sections = [
      // 1. B2B HERO - Premium gradient hero
      {
        id: "premium-hero",
        type: "b2b_hero",
      ...
      // 4. IMAGE_TEXT - Termowizja
      {
        ...
        text: `<p class="text-lg text-zinc-300 leading-relaxed mb-4">Wykonujemy profesjonalne inspekcje termowizyjne budynków mieszkalnych, obiektów przemysłowych oraz instalacji fotowoltaicznych na terenie województwa kujawsko-pomorskiego.</p>

<p class="text-lg text-zinc-300 leading-relaxed mb-6">Sprzęt: <strong class="text-yellow-500">DJI Mavic 3 Thermal</strong> z kamerą o rozdzielczości 640×512 px i dokładności ±2°C. Certyfikat ITC Level 1 gwarantuje professional czytanie i interpretację termogramów.</p>
...
<li>✓ Raport z analizą + termogramy RGB w 48h</li>
        ...
        image: "https://wlasniewski-photo-storage.s3.eu-north-1.amazonaws.com/thermal-example.jpg",
        imagePosition: "right",
        link: "/b2b/termowizja",
        linkText: "SZCZEGÓŁY TERMOWIZJI"
      },
      ...
      // 5. IMAGE_TEXT - Monitoring
      {
        ...
        text: `<p class="text-lg text-zinc-300 leading-relaxed mb-4">Regularna dokumentacja postępów budowy z powtarzalnej pozycji GPS. Idealne dla deweloperów, generalnych wykonawców i zarządców projektów.</p>
...
<li>✓ Dokumentacja zgodności z projektem budowlanym</li>
        ...
        image: "https://wlasniewski-photo-storage.s3.eu-north-1.amazonaws.com/monitoring-example.jpg",
        imagePosition: "left",
        link: "/b2b/monitoring",
        linkText: "SZCZEGÓŁY MONITORINGU"
      },
      ...
      // 6. IMAGE_TEXT - Inspekcje Dachów
      {
        ...
        text: `<p class="text-lg text-zinc-300 leading-relaxed mb-4">Dron zastępuje kosztowne wysięgniki i eliminuje ryzyko pracy na wysokości. Szczegółowa dokumentacja stanu technicznego w kilkanaście minut.</p>
...
<p class="text-sm text-zinc-400 italic">Dla: wspólnot mieszkaniowych, zarządców nieruchomości, rzeczoznawców budowlanych, ubezpieczycieli</p>`,
        image: "https://wlasniewski-photo-storage.s3.eu-north-1.amazonaws.com/roof-inspection.jpg",
        imagePosition: "right"
      },

      // 7. B2B PROCESS - Jak działamy
      {
        id: "process",
        type: "b2b_process",
...
<p class="text-zinc-400">Uprawnienia UAVO A1/A2/A3 (EASA), ubezpieczenie OC operatora drona, certyfikat ITC Level 1 (termowizja budowlana).</p>
    ...
    const result = await prisma.page.update({
      where: { slug: 'b2b' },
      data: {
        title: 'FOTO-DRON — Profesjonalne Usługi Dronem dla Biznesu',
        meta_title: 'Usługi Dronem Toruń Bydgoszcz Włocławek | Termowizja Monitoring | FOTO-DRON',
        meta_description: 'Profesjonalne inspekcje dronem w kujawsko-pomorskim. Termowizja ITC Level 1, monitoring budów, inspekcje dachów. Toruń, Bydgoszcz, Włocławek. Certyfikat, raport 48h.',
        sections: JSON.stringify(sections),
        is_published: true
      }
    });

    console.log('✅ PREMIUM B2B Homepage created!');
    console.log(`   Total sections: ${sections.length}`);
    console.log('   Used components: b2b_hero, b2b_stats, image_text, b2b_process, info_band, b2b_contact');
