    ...
    if (sesjaService) {
        await prisma.package.upsert({
            ...
            create: {
                ...
                features: JSON.stringify(['1 godzina sesji', '30 edytowanych zdjęć', 'Galeria online']),
                is_active: true
            }
        });
        ...
        await prisma.package.upsert({
            ...
            create: {
                ...
                photos_count: 60,
                service_type_id: sesjaService.id,
                features: JSON.stringify(['2 godziny sesji', '60 edytowanych zdjęć', 'Filmik 1 min', 'Galeria premium']),
                is_active: true
            }
        });
    }
    ...
    if (slubService) {
        await prisma.package.upsert({
            ...
            create: {
                ...
                features: JSON.stringify(['8 godzin reportażu', '300+ zdjęć', 'Album 30x30 cm', 'Pendrive']),
                is_active: true
            }
        });
        ...
        await prisma.package.upsert({
            ...
            create: {
                ...
                photos_count: 500,
                service_type_id: slubService.id,
                features: JSON.stringify(['12 godzin reportażu', '500+ zdjęć', 'Film 15 min', 'Dron', 'Album premium', 'Plener']),
                is_active: true
            }
        });
    }
